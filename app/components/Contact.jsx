  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
          <h2 className="text-3xl font-bold font-sans tracking-tight mb-4 bg-gradient-to-r from-foreground via-foreground/80 to-foreground/60 bg-clip-text text-transparent">
            Contact with me
          </h2>
        </motion.div>
